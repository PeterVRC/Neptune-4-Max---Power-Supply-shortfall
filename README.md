...
at all !!  The first thing this sort of occurence can be (in electronics) caused by
...
sold under 1000 different 'brand names', but are all IDENTICAL in "every" way which shows
...
The first thing you might ask, and be appalled by, that these power supplies are sold as
"400W" by that main manufacturer, yet THEY recomment only running them at 80%!!  Why aren't
they just selling a "320W" power supply then!!??  Obviously a higher number will SELL
BETTER!!
...
Voltage "quality" and also lifespan.  AND.... run it up nar the maximums and that
instability can become a NOTABLE amount, which then can cause 'trauma' for digital
circuits - especially COMPUTER systems!
...
time, it runs around a range of 375W to 395W !!!  For the length of time it takes to get 
the Nozzle up to temp. (2 minutes approx?). Well over the "recommended 320W".
...
"330W" or so region of total power sued then. Still JUST over the "320W recommended"
...
and a biot more bed heating, but then add more fans, and Stepper Motors running non-stop.
You are back in the "200W-250W" regions, which is fine as it is under the "320W recommended".
...
I rarely use the to anywhere near their maximum rating, not even 3/4 really, if even 1/2
of that. So I have not seen them reach issue levels. But I also know what HAPPENS in any
power supply, as more load is demanded, and that is where a truly good power supply will
show up it merit/worth, versus a less truly capable one.
These are definitely "Chinese budget low quality' power supplies!! The 400W costs about $25.
A DECENT power supply of 400W would cost more like $100 or more!
You can look at PC ATX power supplies and how they run from $24 to $200 !! When you pay 
...
So then you have a "600W" but "Truly 480W capable" power supply - which will cope and be
